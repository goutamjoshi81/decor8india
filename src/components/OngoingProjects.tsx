...
export const OngoingProjects: React.FC = () => {
  const { projects, setIsBookingOpen } = useApp();
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-16">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full glass-panel border border-[#D4AF37]/30 text-xs font-semibold uppercase tracking-widest text-[#D4AF37]">
            ...
            <span>Live Site Transparency</span>
          </div>
          ...
          <p className="text-neutral-400 font-light text-base sm:text-lg">
            Track real-time progress across our active residential and commercial sites. Clients log into their private dashboard for daily video updates.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {ongoingList.map((project) => (
            <div 
              key={project.id} 
              className="glass-card rounded-2xl overflow-hidden border border-white/10 p-6 space-y-6 hover:border-[#D4AF37]/40 transition-all"
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 items-center">
                ...
                <div className="sm:col-span-7 space-y-3">
                  <div className="flex items-center space-x-2 text-xs text-[#D4AF37] font-semibold">
                    ...
                    <span>Active Site Stage: {project.currentStage}</span>
                  </div>
              ...
              <div className="space-y-2 pt-4 border-t border-white/10">
                <div className="flex justify-between items-center text-xs font-semibold">
                  <span className="text-neutral-300 uppercase tracking-wider">Overall Project Completion</span>
        ...
        {/* CTA banner */}
        <div className="p-8 rounded-2xl glass-panel-gold border border-[#D4AF37]/30 text-center space-y-4">
          <h4 className="font-serif text-2xl font-bold text-white">Want to See Our Live Work in Person?</h4>
          <p className="text-xs text-neutral-300 max-w-xl mx-auto">
            Book a guided site visit to an ongoing residential or commercial project near your location to inspect our carpentry standards and material finish firsthand.
          </p>
          <button 
            onClick={() => setIsBookingOpen(true)}
            className="px-8 py-3 rounded-xl gold-gradient-bg text-black font-bold text-xs uppercase tracking-wider hover:scale-105 transition-transform inline-flex items-center space-x-2"
          >
            <span>Book Live Site Tour</span>
